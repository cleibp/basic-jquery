<h1 align="center"> 🚀 BASIC JQUERY </h1>

## ✍️ Descrição
Exemplificação da sintaxe basica usando JQUERY
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-jquery/.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/abPNOVE) 
